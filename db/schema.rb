...
ActiveRecord::Schema.define(version: 20140820151934) do
  ...
  create_table "arguments", force: true do |t|
    ...
    t.index ["owner_id"], :name => "index_arguments_on_owner_id"
    t.index ["product_group_id"], :name => "index_arguments_on_product_group_id"
  end
  ...
  create_table "product_groups", force: true do |t|
    ...
    t.index ["owner_id"], :name => "index_product_groups_on_owner_id"
  end
