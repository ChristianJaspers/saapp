...
ActiveRecord::Schema.define(version: 20141002161407) do
  ...
  add_index "api_tokens", ["notification_token"], name: "index_api_tokens_on_notification_token", using: :btree
  ...
  add_index "subscriptions", ["ends_at"], name: "index_subscriptions_on_ends_at", using: :btree
  ...
  add_index "subscriptions", ["send_reminder_at"], name: "index_subscriptions_on_send_reminder_at", using: :btree
